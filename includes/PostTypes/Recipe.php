...
class Recipe {
     ...
     * @var string
     */
    private $post_type = 'dvnl_recipes';
    ...
    public function register() {
		...
		add_filter( 'manage_' . $this->post_type . '_posts_columns', array( $this, 'add_recipe_columns' ) );
		add_action( 'manage_' . $this->post_type . '_posts_custom_column', array( $this, 'render_recipe_columns' ), 10, 2 );
    }
	...
	public function register_taxonomies() {
		...
		$tag_labels = array(
			...
			'parent_item'                => __( 'Parent Recipe Tag', 'family-recipe-book' ),
			'parent_item_colon'          => __( 'Parent Recipe Tag:', 'family-recipe-book' ),
