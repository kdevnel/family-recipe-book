 ...
 * @since      1.0.0
 *
 * @package    dvnl_recipes
 * @subpackage dvnl_recipes/public
 */
 ...
 *
 */
class Family_Recipe_Book_Template_Functions {
	...
	public function content_job_title( $item, $meta ) {
		...
		include dvnl_recipes_get_template( 'now-hiring-job-title' );
	...
	public function content_job_location( $item, $meta ) {
		...
		include dvnl_recipes_get_template( 'now-hiring-job-location' );
	...
	public function content_link_end( $item, $meta ) {
		...
		include dvnl_recipes_get_template( 'now-hiring-content-link-end' );
	...
	public function content_link_start( $item, $meta ) {
		...
		include dvnl_recipes_get_template( 'now-hiring-content-link-start' );
	...
	public function content_wrap_end( $item, $meta ) {
		...
		include dvnl_recipes_get_template( 'now-hiring-content-wrap-end' );
	...
	public function content_wrap_start() {
		...
		include dvnl_recipes_get_template( 'now-hiring-content-wrap-start' );
	...
	public function list_wrap_end() {
		...
		include dvnl_recipes_get_template( 'now-hiring-list-wrap-end' );
	...
	public function list_wrap_start() {
		...
		include dvnl_recipes_get_template( 'now-hiring-list-wrap-start' );
	...
	public function single_post_content() {
		...
		include dvnl_recipes_get_template( 'single-recipe-post-content' );
